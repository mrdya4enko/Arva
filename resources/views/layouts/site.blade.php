...
<div class="top">
    <div class="bar theme-d2 left-align large">
        ...
        <a href="#" class="bar-item button padding-large theme-d4"><i class="fa fa-home margin-right"></i>ArVa</a>
        ...
        <a href="#" class="bar-item button hide-small right padding-large hover-white" title="Logout"><i class="fa fa-sign-out" aria-hidden="true"></i></a>
